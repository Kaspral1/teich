# -*- coding: utf-8 -*-
"""Text-only Qwen 3.8 LoRA example using its live multimodal tokenizer."""
...
OUTPUT_DIR = os.environ.get("OUTPUT_DIR", "outputs/qwen38-tool-sft")
HUB_REPO_ID = os.environ.get("HUB_REPO_ID") or ""
HF_TOKEN = os.environ.get("HF_TOKEN") or ""
REASONING_EFFORT = os.environ.get("QWEN38_REASONING_EFFORT", "medium").strip().lower()
if REASONING_EFFORT not in {"low", "medium", "xhigh"}:
    raise ValueError("QWEN38_REASONING_EFFORT must be low, medium, or xhigh")
...
train_dataset, prep_report = prepare_data(
    {
        ...
        "agent": {
            ...
            # Qwen 3.8 supports effort control and preserves historical thought.
...
# The template supplies <think> and <|im_end|>; keep both out of source text.
